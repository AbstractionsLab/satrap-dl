...
class TestTransformLoadSDO(unittest.TestCase):
    ...
    def test_object_refs(self):
        ...
        from different SDOs.
        """
        grouping_test_file = test_utils.get_test_data_path("test_grouping.json")
    ...
    def test_observed_data(self):
        ...
        """
        test_file = test_utils.get_test_data_path("test_observed_data.json")
    ...
    def test_malware_analysis_refs(self):
        ...
        """
        test_file = test_utils.get_test_data_path("test_mwa_refs.json")
        self.orchestrator.transform_load(test_file, self.server, self.db)
