...
import tests.satrap.testing_utils as test_utils
...
class TestRuleTransitiveUse(unittest.TestCase):
    ...
    def test_rule_transitive_use(self):
        test_file = test_utils.get_test_data_path("test_transitive_xyz.json")
    ...
    def test_no_inferred_xyy(self):
        test_file = test_utils.get_test_data_path("test_transitive_xyy.json")
        self.orchestrator.transform_load(test_file, self.server, self.db)
        # check explicit relations
        self.assertTrue(
            test_utils.check_relation_exists(
    ...
    def test_no_inferred_xxy(self):
        test_file = test_utils.get_test_data_path("test_transitive_xxy.json")
        self.orchestrator.transform_load(test_file, self.server, self.db)
        # check explicit relations
        self.assertTrue(
            test_utils.check_relation_exists(
