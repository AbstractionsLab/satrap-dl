...
normative: true
ref: ''
reviewed: spww7DSzaVckGDo7PCKCIrML8r8hl-uVL6GFE6xdCnA=
---

# SATRAP: System structure overview

This UML composite structure diagram shows the overview of SATRAP along with the systems on which it has some dependency.

![Composite structure diagram of SATRAP](assets/2B1D0_DIA_composite-structure.png)
