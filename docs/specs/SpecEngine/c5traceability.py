...
def print_coverage_section(
    ...
    if _RICH:
        ...
        console.print(
            ...
            f"— {len(uncovered_items)} {subject_col} item(s) with status '{uncovered_label}'"
        )
    else:
        col_w = 12
        link_w = 40
        ...
        print(f"{len(uncovered_items)} {subject_col} item(s) with status '{uncovered_label}'.")
...
def build_html_coverage_section(
    ...
    parts = [
        ...
        f"<p>{_badge(covered, total)} &nbsp; {len(uncovered_items)} {subject_col} item(s) with status '{uncovered_label}'</p>",
