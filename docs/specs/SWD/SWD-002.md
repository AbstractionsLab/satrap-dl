...
- keyword: ETLOrchestrator
  ...
  type: file
reviewed: KNAi8jfIdjSkuOFgmUq4o4i4A7mB-A2xNhZ4oFkw01s=
---
...
A concrete class definition aimed at ingesting data form sources in STIX 2.1 is depicted below. This classes implement and inherit from the abstract classes depicted in SWD-001.

![Concrete STIX-specific ETL class diagram](assets/2C0A2B_DIA_Specific-ETL-design.drawio.png "Concrete STIX-specific ETL class diagram"){: width="80%"}
