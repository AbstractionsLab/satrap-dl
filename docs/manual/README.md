...
- [Full project README](/README.md) — Project overview and getting started
- [Deployment guide](/deployment/README.md) — Infrastructure stack deployment
- [Technical specifications](https://abstractionslab.github.io/satrap-dl/traceability/) — Architecture and requirements
- [Jupyter notebooks](/docs/notebooks/) — Interactive examples
