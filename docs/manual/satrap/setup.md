...
- **transform_src**: The path of a STIX 2.1 local file to be used as the source of the transformation process. This is the default value for the `-f` argument of the `tl` command, set to `tests/satrap/data/test-sample.json` if not provided.
